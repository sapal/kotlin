...
public class QuickFixTestGenerated extends AbstractQuickFixTest {
    ...
    @TestMetadata("idea/testData/quickfix/typeInference")
    public static class TypeInference extends AbstractQuickFixTest {
        public void testAllFilesPresentInTypeInference() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.GenerateTests", new File("idea/testData/quickfix/typeInference"), Pattern.compile("^before(\\w+)\\.kt$"), true);
        }
        
        @TestMetadata("beforeRecursiveDefinitionProperties.kt")
        public void testRecursiveDefinitionProperties() throws Exception {
            doTest("idea/testData/quickfix/typeInference/beforeRecursiveDefinitionProperties.kt");
        }
